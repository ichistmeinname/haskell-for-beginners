> {-# LANGUAGE GADTSyntax #-}
> 
> module Lecture03_FunctionDefinitions where
...
In order for this imports to work as expected, make sure that you start GHCi on the top-level directory of the repository, so that the module paths are solved correctly.
    ...
    $> ls
    README.md Lecture01_DataAndFunctions.lhs Lecture02_MoreData.lhs Lecture03_FunctionDefinitions.lhs
    $> ghci
    GHCi, version 8.6.5: http://www.haskell.org/ghc/  :? for help
    Prelude> :l Lecture03_FunctionDefinitions
